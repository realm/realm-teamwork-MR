...
class SortOptionsTableViewController: UITableViewController {
    ...
    let sortOptions: Array<Dictionary<String, String>> = [
        ["dueDate": NSLocalizedString("Due Date", comment: "Due Date")],
        ["title": NSLocalizedString("Title", comment: "Title")],
        ["isCompleted": NSLocalizedString("Completed", comment: "Completed")],
    ]

    var delegate: SortOptionsSelectionProtocol?
    let cellIdentifier = "SortOptionsCell"
    var currentlySelectedSortOption = "dueDate" // start out with dateSort
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        if currentlySelectedSortOption.isEmpty {
            currentlySelectedSortOption = "dueDate"
        }
    }
